...
public class TestAnnotationProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        Set<? extends Element> bindViewElements = roundEnvironment.getElementsAnnotatedWith(TestAnnotation.class);
...
//            int id = bindView.value();
    ...
    private void createFile(TypeElement enclosingElement, String bindViewFiledClassType, String bindViewFiledName, int id) {
        ...
        try {
            JavaFileObject jfo = mFiler.createSourceFile(pkName + ".AutoCreate", new Element[]{});
